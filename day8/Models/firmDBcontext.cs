...
namespace day8solid.Models
{
    public class firmDBcontext:DbContext
    {
        ...
        {
            optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=DESKTOP-GFUDS8G\\SS17;Initial Catalog=firm;Integrated Security=True;TrustServerCertificate=True");
        }
